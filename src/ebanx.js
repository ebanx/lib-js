  ...
  return {
    ...
    card: {
      ...
      validateNumber: function (number) {
        if (!this.luhnAlgCheck(String(number)))
  ...
  var utilsModule = {
    ...
    creditCardScheme: function (cardNumber) {
      ...
      var schemes = {
        br: {
          aura: /^50[0-9]{14,17}$/,
          elo: /^(4011|438935|45(1416|76|7393)|50(4175|6699|67|90[4-7])|63(6297|6368))/,
          diners: /^3(?:0[0-5]|[68][0-9])[0-9]{11}$/,
          discover: /^6(?:011|5[0-9]{2})[0-9]{12}$/,
          hipercard: /^(38|60)[0-9]{11,17}$/,
          mastercard__custom: /^(230650)/,
        },
        mx: {
          carnet: /^5[0-9][0-9]{14}$/,
...
EBANX.deviceFingerprint = {
  ...
  notifyPayOnError: function (error) {
    ...
    try {
      pik = EBANX.config.getPublishableKey();
    } catch (e) {
      pik = '';
    }

    var data = {
      publicIntegrationKey: pik,
